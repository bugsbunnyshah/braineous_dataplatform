...
@QuarkusTest
public class MySqlStagingStoreTests {
    private static Logger logger = LoggerFactory.getLogger(MySqlStagingStoreTests.class);
    ...
    public void testStagingStoreLifeCycle() throws Exception{
        logger.info("****RUNNING*****: MYSQL_STAGING_STORE_LIFECYCLE");
        String datasetLocation = "targetSystem/core/driver/scenario1.json";
        String configLocation = "targetSystem/core/driver/mysql_pipe_config.json";
