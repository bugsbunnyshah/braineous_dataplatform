...
@QuarkusTest
public class ElasticSearchStagingStoreTests {
    private static Logger logger = LoggerFactory.getLogger(ElasticSearchStagingStoreTests.class);
    ...
    public void testStagingStoreLifeCycle() throws Exception{
        logger.info("****RUNNING*****: ELASTIC_SEARCH_STAGING_STORE_LIFECYCLE");
        String datasetLocation = "targetSystem/core/driver/scenario1.json";
        String configLocation = "targetSystem/core/driver/elasticsearch_pipe_config.json";
