...
@QuarkusTest
public class SnowflakeStagingStoreTests {
    private static Logger logger = LoggerFactory.getLogger(SnowflakeStagingStoreTests.class);
    ...
    private void execute(String datasetLocation, String configLocation) throws Exception{
        ...
        for(StagingStore stagingStore: registeredStores){
            ...
            if(records != null) {
                ...
                logger.info("************************************************");
                logger.info("STAGING_STORE_DOES_NOT_IMPLEMENT_READ_INGESTION");
                logger.info("***********************************************");
            }
