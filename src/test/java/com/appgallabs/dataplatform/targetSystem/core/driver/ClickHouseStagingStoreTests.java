...
@QuarkusTest
public class ClickHouseStagingStoreTests {
    private static Logger logger = LoggerFactory.getLogger(ClickHouseStagingStoreTests.class);
    ...
    public void testStagingStoreLifeCycle() throws Exception{
        ...
        String configLocation = "targetSystem/core/driver/clickhouse_pipe_config.json";
